...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'A clean Flutter project with Riverpod, Freezed, and localization support'**
  ...
  /// Riverpod feature description
  ///
  /// In en, this message translates to:
  /// **'Riverpod State Management'**
  String get featureRiverpod;

  /// Freezed feature description
  ///
  /// In en, this message translates to:
  /// **'Freezed Data Classes'**
  String get featureFreezed;

  /// Localization feature description
  ///
  /// In en, this message translates to:
  /// **'Localization Support'**
  String get featureLocalization;

  /// Clean architecture feature description
  ///
  /// In en, this message translates to:
  /// **'Clean Architecture'**
